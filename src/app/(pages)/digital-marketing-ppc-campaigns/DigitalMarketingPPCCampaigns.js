...
import { 
  ...
  Target, BarChart3, Filter, LineChart,
  Share2, DollarSign, TrendingUp, Users
} from "lucide-react";
  ...
  const marketingServices = [
    {
      ...
      bullets: ["Facebook Ads", "Instagram Ads", "Engagement Growth"],
      color: "orange",
    ...
    },
    {
      ...
      bullets: ["Search Ads", "Display Ads", "YouTube Ads"],
      color: "blue",
    ...
    },
    {
      ...
      bullets: ["LinkedIn Ads", "TikTok Campaigns", "Brand Awareness"],
      color: "orange",
    ...
    },
    {
      ...
      bullets: ["Remarketing", "Conversion Tracking", "ROI Maximization"],
      color: "blue",
      iconComponent: <Filter className="w-8 h-8 text-white" />
    },
    {
      id: 5,
      ...
      bullets: ["Strategy Planning", "A/B Testing", "Performance Optimization"],
      color: "purple",
      iconComponent: <LineChart className="w-8 h-8 text-white" />
    },
    {
      id: 6,
      ...
      bullets: ["Budget Management", "ROI Reporting", "Cost Optimization"],
      color: "emerald",
      iconComponent: <DollarSign className="w-8 h-8 text-white" />
    }
  ];

  return (
    <div className="min-h-screen w-full bg-white">
      {/* Hero Section - PURELY RESPONSIVE (NO STYLING CHANGES) */}
      <motion.section 
        ref={heroRef}
      ...
      >
        ...
        {/* CONTENT WITH IMAGE - EXACTLY AS PROVIDED */}
    ...
    <Link href="/contact-us" className="mt-auto">
      <Button className="group bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 text-sm sm:text-base md:text-lg rounded-xl w-full sm:w-auto">
        Launch Your Campaign
            ...
            {/* RIGHT SIDE - IMAGE CONTAINER (market.png) - MOBILE CENTER, DESKTOP RIGHT */}
            <motion.div 
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            {/* Meta (Facebook & Instagram) Ads - Orange Theme */}
            <motion.div
            ...
            {/* Google Ads (Search, Display, YouTube) - Blue Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* LinkedIn & TikTok Campaigns - Orange Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Remarketing & Conversion Tracking - Blue Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="relative bg-white rounded-2xl p-8 border border-blue-200 shadow-lg group-hover:shadow-2xl group-hover:shadow-blue-100/50 group-hover:border-blue-300 transition-all duration-500 h-full flex flex-col overflow-hidden">
                ...
                {/* Light Spread Effect */}
                <div className="absolute inset-0 overflow-hidden rounded-2xl">
                  <div className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-blue-500/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
                  <div className="absolute bottom-1/4 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-cyan-500/5 rounded-full blur-3xl translate-x-1/2 translate-y-1/2"></div>
                </div>
            ...
            {/* Campaign Strategy & A/B Testing - Purple Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Budget Optimization & ROI Reporting - Emerald Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
