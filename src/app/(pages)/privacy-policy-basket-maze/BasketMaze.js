    ...
    <div className="min-h-screen bg-[#f8f0e6] py-8 px-4">
      ...
      <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg border border-orange-100 shadow-[0_0_20px_rgba(255,165,1,0.2)]">
        ...
        <div className="text-gray-800 space-y-4">
          ...
          <p>
            Basket Maze enables users to be in control of their personal data. We also provide controls that allow users to manage their privacy choices regarding advertising preferences through consent dialogs. This Privacy Policy provides information about how Basket Maze processes and protects this data in compliance with applicable regulations, including the EU General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA).
          </p>
          ...
          <p>
            Eraflip Tech is responsible for lawfully processing your data as carried out through the game Basket Maze.
          </p>
          ...
          <p>
            When you use Basket Maze, we integrate Google AdMob for showing ads. AdMob may collect certain information automatically, including:
          </p>
          ...
          <p>
            We do not collect your name, email, or any personally identifying information.
          </p>
          ...
          <p>
            Basket Maze does not use cookies directly. However, AdMob may use cookies and similar technologies for ad delivery. Please review Google's policy on cookies.
          </p>
          ...
          <p>
            Our game is designed for users of all ages, including children. We comply with COPPA and other child privacy protection laws. We do not knowingly collect personal data from children. Ads displayed in the game are served according to Google's Families Policy for child-directed content.
          </p>
