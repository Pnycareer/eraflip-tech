...
import { 
  SparkleIcon, Zap, Rocket, ArrowRight, MessageCircle, TrendingUp,
  Search, Settings, MapPin, Link2, Share2, BarChart,
  FileSearch, Globe, ShoppingBag, FileText, ExternalLink
} from "lucide-react";
...
const SearchEngineOptimization = () => {
  ...
  // SEO Services Data with bullets and colors
  const seoServices = [
    { 
      id: 1, 
      ...
      bullets: ["Website Analysis", "Keyword Research", "Competitor Analysis"],
      color: "orange",
      iconComponent: <Search className="w-8 h-8 text-white" />
    },
    { 
      id: 2, 
      ...
      bullets: ["On-Page SEO", "Off-Page SEO", "Technical SEO"],
      color: "blue",
    ...
    { 
      ...
      bullets: ["Local SEO", "E-Commerce SEO", "Google Business"],
      color: "orange",
      iconComponent: <MapPin className="w-8 h-8 text-white" />
    },
    { 
      id: 4, 
      ...
      bullets: ["Content Optimization", "Internal Linking", "User Experience"],
      color: "blue",
      iconComponent: <Link2 className="w-8 h-8 text-white" />
    },
    { 
      id: 5, 
      ...
      bullets: ["Backlink Building", "Guest Posting", "Authority Building"],
      color: "purple",
      iconComponent: <Share2 className="w-8 h-8 text-white" />
    },
    { 
      id: 6, 
      ...
      bullets: ["Monthly Reports", "Ranking Analysis", "Performance Tracking"],
      color: "emerald",
    ...
    switch(color) {
      case 'orange':
        return {
          ...
          iconHoverGradient: 'from-orange-600 to-amber-500',
          buttonGradient: 'from-orange-500 to-amber-400',
          buttonHoverGradient: 'from-orange-600 to-amber-500',
          textHover: 'group-hover:text-orange-700',
          dotColor: 'bg-orange-500',
          dotHover: 'group-hover/item:bg-orange-600',
          glowFrom: 'from-orange-100/20 via-amber-50/15 to-amber-100/20',
          lightFrom: 'from-orange-100/10',
          lightTo: 'to-transparent'
        };
      case 'blue':
        return {
          ...
          iconHoverGradient: 'from-blue-600 to-cyan-500',
          buttonGradient: 'from-blue-500 to-cyan-400',
          buttonHoverGradient: 'from-blue-600 to-cyan-500',
          textHover: 'group-hover:text-blue-700',
          dotColor: 'bg-blue-500',
          dotHover: 'group-hover/item:bg-blue-600',
          glowFrom: 'from-blue-100/20 via-cyan-50/15 to-cyan-100/20',
          lightFrom: 'from-blue-100/10',
          lightTo: 'to-transparent'
        };
      case 'purple':
        return {
          ...
          hoverShadow: 'group-hover:shadow-violet-100/50',
          iconGradient: 'from-violet-500 to-purple-400',
          iconHoverGradient: 'from-violet-600 to-purple-500',
          buttonGradient: 'from-violet-500 to-purple-400',
          buttonHoverGradient: 'from-violet-600 to-purple-500',
          textHover: 'group-hover:text-violet-700',
          dotColor: 'bg-violet-500',
          dotHover: 'group-hover/item:bg-violet-600',
          glowFrom: 'from-violet-100/20 via-purple-50/15 to-purple-100/20',
          lightFrom: 'from-violet-100/10',
          lightTo: 'to-transparent'
        };
      case 'emerald':
        return {
          ...
          hoverShadow: 'group-hover:shadow-emerald-100/50',
          iconGradient: 'from-emerald-500 to-teal-400',
          iconHoverGradient: 'from-emerald-600 to-teal-500',
          buttonGradient: 'from-emerald-500 to-teal-400',
          buttonHoverGradient: 'from-emerald-600 to-teal-500',
          textHover: 'group-hover:text-emerald-700',
          dotColor: 'bg-emerald-500',
          dotHover: 'group-hover/item:bg-emerald-600',
          glowFrom: 'from-emerald-100/20 via-teal-50/15 to-teal-100/20',
          lightFrom: 'from-emerald-100/10',
          lightTo: 'to-transparent'
        };
      default:
        return {
  ...
  return (
    <div className="min-h-screen w-full bg-white">
      {/* Hero Section - EXACT SAME AS OTHER PAGES */}
      <motion.section 
        ref={heroRef}
      ...
      >
        ...
        {/* CONTENT WITH IMAGE - SAME LAYOUT AS OTHER SECTIONS */}
...
<div className="md:w-2/3">
  ...
  >
    <Link href="/contact-us" className="mt-auto">
              ...
              <div className="relative w-full h-auto flex items-center justify-center">
                <div className="relative transform md:rotate-6 mx-auto md:mx-0">
                  ...
                  {imgError ? (
                    ...
                    <div className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] bg-gradient-to-r from-orange-400 to-blue-400 rounded-3xl flex items-center justify-center shadow-2xl mx-auto md:mx-0">
                      <span className="text-white text-2xl font-bold">SEO</span>
                    </div>
                  ) : (
                    // Next.js Image Component
                    <Image
                      src="/images/seoimage1.png"
                      alt="Search Engine Optimization"
                      width={600}
                      height={600}
                      priority
                      className="object-contain max-h-[180px] sm:max-h-[210px] md:max-h-[280px] lg:max-h-[320px] xl:max-h-[360px] w-auto drop-shadow-2xl mx-auto md:mx-0"
                      style={{ 
                        height: 'auto',
                        maxWidth: '100%',
      ...
      {/* Services Section - FIXED GRID LIKE SOCIAL MEDIA MANAGEMENT PAGE */}
      <motion.section
        ref={servicesRef}
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            {/* Website Audit & Keyword Research - Orange Theme */}
            <motion.div
            ...
            {/* On-Page, Off-Page & Technical SEO - Blue Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Local & E-Commerce SEO - Orange Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Content Optimization & Internal Linking - Blue Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Backlink Building & Guest Posting - Purple Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Monthly SEO Reports & Ranking Analysis - Emerald Theme */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
