    ...
    <div className="min-h-screen bg-[#f8f0e6] py-8 px-4">
      ...
      <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg border border-orange-100 shadow-[0_0_20px_rgba(255,165,1,0.2)]">
        ...
        <div className="text-gray-800 space-y-4">
          ...
          <p>
            Jungle Fury enables users to be in control of their personal data. We also provide controls that allow users to manage their privacy choices regarding advertising preferences through consent dialogs. This Privacy Policy provides information about how Jungle Fury processes and protects this data in compliance with applicable regulations, including the EU General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA).
          </p>
          ...
          <p>
            Eraflip Tech is responsible for lawfully processing your data as carried out through the game Jungle Fury.
          </p>
          ...
          <p>
            When you use Jungle Fury, we integrate Google AdMob for showing ads. AdMob may collect certain information automatically, including:
          </p>
          ...
          <p>
            Jungle Fury does not use cookies directly. However, AdMob may use cookies and similar technologies for ad delivery. Please review Google's policy on cookies.
          </p>
